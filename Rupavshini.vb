...
Sub RupavahiniPayment20200130PaymentV2()
'
' RupavahiniPayment20200130PaymentV1 Macro
'
...
'Select cell g1 and name it as Date
 ...
 'Using text to column populate Column G with Date
  ...
  'Add sheet
'   Sheets.Add
    Sheets.Add(After:=ActiveSheet).Name = "Rupavahini_Payment_Total"
   ...
   'Create the Cache
    ...
    Sheets("Rupavahini_Payment_Total").Select
    Cells(3, 1).Select
...
Sub RupavahiniSMSOutbound31012020V2()
'
...
'
    ...
    Dim lr As Long
    'lr = ActiveSheet.Cells(ActiveSheet.Rows.Count, "A2").End(xlDown).Row
    ...
    'Range("N2").Value = Application.WorksheetFunction.Index(Sheets("SMSv2").Range("A2:L" & lr), Application.Match(Sheets("SMSv2").Range("C2"), Sheets("SMSv2").Range("A2:A" & lr), False), 4)
    'ActiveCell.FormulaR1C1 = "=INDEX(SMSv2!" & arrayRangeAll & ",MATCH(SMSv1!RC[-11],SMSv2!" & arrayRangeID & ",0),4)"
        '"=INDEX(SMSv2!R2C1:R2676800C11,MATCH(SMSv1!RC[-11],SMSv2!R2C1:R2676800C1,0),4)"
    ...
    'ActiveWorkbook.PivotCaches.Create(SourceType:=xlDatabase, SourceData:= _
        "SMSv1!R1C1:R25630C8", Version:=6).CreatePivotTable TableDestination:= _
        "Sheet1!R3C1", TableName:="PivotTable8", DefaultVersion:=6
    ...
    Sheets.Add(After:=ActiveSheet).Name = "Rupavahini_SMS_Outbound_Total"
   ...
   'Create the Cache
    ...
    'Select the destination sheet
    Sheets("Rupavahini_SMS_Outbound_Total").Select
    Cells(3, 1).Select
...
Sub RupavahiniOutboundDaily20200205V2()
'
...
'
    ...
    Sheets.Add(After:=ActiveSheet).Name = "Rupavahini_Outbound_Daily"
    Sheets("SMSv1").Select
    Columns("H:H").Select
    Selection.Copy
    Sheets("Rupavahini_Outbound_Daily").Select
    ActiveSheet.Paste
    Sheets("SMSv1").Select
    Columns("D:D").Select
    Selection.Copy
...
End Sub
Sub RupavahiniPaymentsDaily20200205V2()
'
' RupavahiniPaymentsDaily20200205V1 Macro
'

'
    Sheets.Add(After:=ActiveSheet).Name = "Rupavahini_Payments_Daily"
    Sheets("Payment").Select
    Columns("G:G").Select
    Selection.Copy
    Sheets("Rupavahini_Payments_Daily").Select
    ActiveSheet.Paste
    Sheets("Payment").Select
    Columns("E:E").Select
    Selection.Copy
...
Sub RupavahiniDailyDashBoardAndDashBoard20200205v2()
'
...
'
    ...
    ActiveCell.Formula = _
        "=IFERROR(INDEX(Rupavahini_Outbound_Daily!$A$2:$C$" & lr2 & ",MATCH(Daily_Dashboard!B2,Rupavahini_Outbound_Daily!$B$2:$B$" & lr2 & ",0),3),0)"
    Range("D2").Select
...
Sub RupavahiniOveruseSMS20200205v1()
'
...
Sub RupavahiniProcessAllInOne20200205V2()
    Call RupavahiniPayment20200130PaymentV2
    Call RupavahiniSMSOutbound31012020V2
    Call RupavahiniOutboundDaily20200205V2
    Call RupavahiniPaymentsDaily20200205V2
    Call RupavahiniDailyDashBoardAndDashBoard20200205v2
    Call RupavahiniOveruseSMS20200205v1
    
    Sheets("Final_Report").Select
    
    Range("A5").Select
    Range("A5").Value = OverUseSMS
    Range("C5").Value = Round(Revenue, 2)
End Sub
